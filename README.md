...
* Divides from the **Kidney meridian**
* Begins:

  * Behind the **navicular bone**
  * Inside the **heel bone**
* Passes:

  * **KI-2 (Rangu)**
  * **KI-6 (Zhaohai)**
  * **KI-8 (Jiaoxin)** — accumulation point
* Circles the **internal malleolus**
* Ascends the **medial leg**
* Rises to:

  * **Inguinal crease**
  * **Sexual organs (yin region)**
* Passes through:

  * **Pelvic cavity**
  * **Abdomen**
* Ascends the chest to:

  * **Quepen (ST-12)**

* Passes:

  * In front of **Renying (ST-9)**
  * Through the **throat**
* Enters:
...
* Meets:
  ...
  * **Bladder meridian**
  * **Yang Qiao Mai** at the internal canthus
* Enters the **brain**
* Some texts describe emergence at **GB-20**

---

## RELATIONSHIP WITH YANG QIAO MAI

* Yin and Yang Qiao:

  * Originate from the brain
  * Cross at the **internal canthus (BL-1)**
* Functional dynamics:
...
* Eye function:
  ...
  * Both moisten and regulate the eyes
* Excess patterns:

  * **Yin Qiao excess** → eyes close, cannot open
  * **Yang Qiao excess** → eyes open, cannot close
* Musculoskeletal reflection:

  * Excess Yin → medial leg tension, lateral flaccidity
  * Excess Yang → lateral tension, medial flaccidity
...
* Holds:
  ...
  * Muscles to tissue
  * Skeletal framework upright
  * Organs in place
  * Eyes within the head
* Supports:

  * Internal alignment
  * Stability of posture and gait
...
* Supports:
  ...
  * Destiny and life trajectory
  * Inner strength and faith
  * Survival through adversity
* Mobilizes:

  * Consciousness for self-reflection
  * Insight and internal awareness
* Interdependent with:

  * **Yang Qiao Mai**
  * **Yin Wei Mai**
* Root pathology may originate in Yin Qiao and affect Yang Qiao

---

## PSYCHO-EMOTIONAL THEMES

### Core Themes

* Self-regard and self-honesty
* Capacity for self-illumination
* Ability to take a stand in life
* Comfort with one’s true nature
...
* Narcissistic inward fixation (in some cases)
...
* Loss of motivation
* Desire to withdraw or sleep excessively
* Difficulty engaging with the world
* Reliance on external validation
* Difficulty speaking one’s truth

---

## STASIS OF YIN QIAO MAI (MERGED)

### Physiological Stasis

* Treats:

  * Accumulations in the abdomen
  * Stagnation of:
...
* Clinical signs:
  ...
  * Obstruction of abdominal function
...
* Genital pain
* Pelvic disorders
* Vulnerability to parasitic infestation (Gu)

---

## WITHDRAWAL, SLEEP & EYES

* Yin stagnation:

  * Weighs down the body and psyche
  * Makes eyes heavy and difficult to open
* Sleep:

  * Excessive but unrefreshing
  * Used as withdrawal from pain
...
* Pathway passes through:
  ...
  * **ST-12**
  * **ST-9**
* Yin accumulation here may cause:

  * Difficulty swallowing
  * Throat tightness or pain
  * Goiter
  * Chronic lymph swelling (neck/clavicle)
* Associated with:

  * Suppressed speech
  * Fear of expressing truth
  * Long-standing invalidation

---

## SUICIDAL IDEATION (TEXT-BOUND SUMMARY)

* Occurs when:

  * Yin Qiao can no longer veil suffering
* Seen in:

  * Chronic abuse or bullying
* Yin Qiao treatment:

  * May reduce stagnation
  * May support survival and resilience
* **Referral to mental health care is essential**
...
* Body fat viewed as:
  ...
  * Stagnating yin
  * Protective buffer against judgment
* Weight loss:

  * Increases vulnerability
* Yin Qiao treatment supports:

  * Self-acceptance
  * Reduced need for buffering
...
* Eye diseases
* Somnolence
* Abdominal pain with masses
* Wei syndrome:

  * Medial leg tightness
  * Lateral leg flaccidity
* Urinary disorders (excess patterns)
* Obstetric conditions (excess, blood stasis):

  * Prolonged labor
  * Placental retention
  * Unilateral post-partum pain
* Lower burner obstruction:
...
## Trajectory Points and its Functions

1. KIDNEY 2 (Blazing Valley)
* it is Fire in the Water
* It is the Fire or passion that can guide our will to live the type of life we desire.
* can reinforce Kidney Yang
* it is the dragon in the Water
* Yang in the Yin or Fire in the Water
* It invigorates the Yin Qiao channel
* Clears false heat
* Clears empty heat from Kidneys (night sweats, restless feet)
* Cools the blood
* Regulates kidneys (genital issues, kidney stones) and lower jiao (lower extremity pain)
* Moistens throat; clears painful obstruction in throat
* Invigorates Yin Qiao Mai
* Unfreezes ice and softens water; makes channel more fluid and vibrant
* Allows for self-expression—Yin Qiao Mai specifically
* Affects one’s ability to express life force which resides in the Heart through articulation or through vision
* Invigorates a person to experience passion and manifest it
* Helps correct qi (body–mind–spirit) to rectify feelings of shame or guilt that are carried in this
particular vessel so a person can shed habitual tendency of guilt

2. Kidney 6 Zhao Hai Shining Sea
* Confluent point
* It is a portal to see inside our Water, to see our reflection, our true nature.
* The Kidneys and Water are the most Yin organs, substance, and area of the body.
* It is a way to see our Yuan Shen.
* When we are lost, disconnected, lack self-esteem, and no longer trust ourselves, Shining Sea assists in seeing and experiencing our shining spirit.
* It can influence self-confidence, self-trust, and self-esteem. It allows people to see themselves clearly.
* It increases the ability to stand up for yourself. Reinforces the Kidneys and the zhi.
* Calms the shen and the mind
* Nourishes Yin, cools blood, and nourishes Water and fluids
* Zhao Shen influences the eyes
* It regulates the uterus and menstruation

3. Kidney 8 Jiao Xin Intersection Reach  
* Junction of Faithfulness 
* Trusting and Good Exchange
* Cleft point.
* Water can take any shape and form
* Its nature is to adapt, join, and interact with everything
* Assists in the ability to be open and share
* includes having faith and trust in self and in others
* When we have lost faith and trust, Jia Xin can help restore those natural and intrinsic aspects 
of our life, allowing for smoother interactions and exchanges.
* It stimulates the channel and clears stagnations
* This cleft point helps a person move past their current condition
* It benefits the uterus and regulates menstruation.
* can be used with Gallbladder 34, to help a person start moving outward in life
* Regulates Chong Mai and Ren Mai
* Benefits the uterus, regulates menstruation; stops uterine bleeding; amenorrhea; dysmenorrhea
* Releases deficiency heat from Kidneys (menopausal hot flashes and night sweats, inappropriate sweating in general, lumbar pain)
* In combination with other points, releases heat from blood
* Resolves dampness, resolves damp-heat in the lower jiao
* Strongly influences the pelvic cavity (addresses many fertility issues, shan disorder)
* Helps a person identify the self and personal needs in cases where they are disconnected from their own needs (environmental, relational, physical, etc.)
* Offers a gateway to understand what is possible and what is right for self; provides spiritual direction
...
* Expels wind and clears heat
* Assists with judgment
* Assists in the movement of vision (physiologically,
metaphorically)
* Supports the ability to see clearly what lies ahead
and digest what is seen
* Opens structure so a person is able to receive,
discern, and appropriately disseminate the information
* Is great for someone who has a difficult time with discernment, which can create boundary issues
...
* Activates the channel and alleviates pain
* Treats eating disorders, addresses metabolism problems (in cases of unhealthy relationship with food, to help the person lose weight by identifying the issue and understanding how to make changes
...
8. STOMACH 9
* Regulates vertical movement of qi and blood
through the neck and subdues rebellion
* Benefits the throat and neck
* Dissipates nodules, alleviates pain
* Treats conditions related to glands (thyroid, adrenals)
* Facilitates vision—big-picture perspective

9, STOMACH 12
* Subdues rebellious qi; descends Lung qi and clears heat from the chest
* Activates the channel and alleviates pain
* Treats conditions related to glands (thyroid, adrenals)
* Facilitates vision—big-picture perspective
* It is a space that facilitates the flow of substances from Heaven above to Earth below. This space connects the head and chest, and allows for the interaction of the great vessels and innervations in the neck
* it also connects the front of the neck to the back of the neck at Da Zhui Du 14.
* It can transfer pathogens from all Yang channels, except the Bladder, to Da Zhui
* It can collect pathogens in the neck and the surrounding areas and store them. That can cause certain muscle and skeletal conditions. 
* Many qi gong forms include movements to open this area up, to allow the smooth flow of qi through the head, neck, and chest.
* It connects to Du 14, and facilitates the upright posture. This point and area has a strong downward action; it strongly descends qi. 
* It allows the heavenly, head qi to flow down. In the Microcosmic Orbit meditation the neck is a major area to let qi flow down the top of the Du hannel into the Ren channel

10. BLADDER 1
* Brightens the eyes
* Expels wind and clears heat; stops itching
* Treats neurological issues; specifically stimulates the pituitary gland
* Facilitates vision—big-picture perspective
...
* Nourishes marrow and clears the brain
* Activates the channel and alleviates pain
* Treats wind conditions, releases exterior conditions, relaxes rigidity in thinking or rigidity that manifests in the body (when the rigidity has manifested into physical symptoms of stiffness, pair Yin Qiao Mai with Yang Qiao Mai + GB20 (disperse); 
* if rigidity exists in the mind only, use Yin Qiao Mai along with GB34)
...
* Treats wind conditions and releases exterior conditions
* Relaxes rigidity in thinking or rigidity that manifests in the body (when the rigidity has manifested into physical symptoms of stiffness, pair Yin Qiao Mai with Yang Qiao Mai + GB20 (disperse);
* if rigidity exists in the mind only, use Yin Qiao Mai with GB34)

3. CONCEPTION VESSEL 10
